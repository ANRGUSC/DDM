...
class Order extends Component {
  ...
  sdppStart = () => {
    ...
    ws.onclose = () => {
      ...
      if (
        ...
        parseInt(this.state.quantity / 3, 10) + 1
      ) {
        this.setState({
          iconLoading: false,
          display: "Buy Again!",
  ...
  send1 = (mess) => {
    ...
    const transaction = {
      ...
      address:
        "XKVOPYNOEMGHSMNVHQXZRESW9MORQFWWZF9PYYQXH9DWMGIEJQNCOHGZWMVHDTWJQYLSBLISKYLPPDFIWHFGGDQPHD",
      value: 0,
      ...
      (error, success) => {
        if (error) {
          ...
          const obj = {
            description: mess,
            url:
              "https://thetangle.org/bundle/" + success[0]["bundle"].toString(),
          };
    ...
    return (
      <div className="orderform">
        ...
        <Form>
          ...
          <div className="seedform"></div>

          <FormItem
            className="seedquantity"
            label={<span>Seed&nbsp;</span>}
            {...formItemLayout}
          >
            <Input value={this.state.seed} onChange={this.handleSeedChange} />
          </FormItem>
